...
```
PASO 0: Orientación (si algo no está claro)
□ Leer INDICE_MAESTRO_DOCUMENTOS.md (raíz del repo) — mapa completo de documentos
□ El índice dice dónde está cada HO, SPEC, OPERATIVO y plantilla
...
> **¿No sabes dónde está un documento?** → Consultar [`INDICE_MAESTRO_DOCUMENTOS.md`](../../INDICE_MAESTRO_DOCUMENTOS.md) — tiene el mapa completo del repo con propósito y ubicación de cada archivo.

| Qué verificar | Fuente primaria | Fuente secundaria |
|---------------|----------------|-------------------|
| Mapa de documentos del proyecto | `INDICE_MAESTRO_DOCUMENTOS.md` (raíz del repo) | — |
| HO de la fase activa | `memory-service-project/Release2.0/PJM/HO_FASE_[N]_*.md` | CONTEXTO_SA_REVIEWER_SESION |
| Alcance IN/OUT del proyecto | `memory-service-project/knowledge/kickoff/KICKOFF_ACTA_2026-05-04.md` | Handoff del PM |
...
| Fases y deliverables | `memory-service-project/00-agent-setup/03.standard/05_CATALOGO_DELIVERABLES.md` | HO de la fase |
| **Dónde depositar entregables** | **`memory-service-project/00-agent-setup/06.Skills/file-structure/SKL-STRUCTURE-01_ubicar-entregable.md`** | V3.1 |

> **Regla:** En conflicto entre documentos → **SPEC v1.9 manda**.
> **Regla al generar ASSIGNMENTs:** las rutas de entregables SIEMPRE deben seguir SKL-STRUCTURE-01 (`phases/{fase}/deliverables/`). Nunca usar `docs/`, `Release2.0/`, ni rutas ad-hoc.
...
[ ] Scope dentro del IN SCOPE del KICKOFF_ACTA_2026-05-04.md
```
