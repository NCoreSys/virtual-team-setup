# SETUP — Project Manager (Observador) (PJM) | Memory Service

**Propósito:** Esto es lo que debes leer al iniciar sesión como Project Manager (Observador) de Memory Service. No leas toda la carpeta `00-platform/`. Solo lo que dice acá.
...
| 3 | `c:/Users/Martin/Documents/virtual-teams/virtual-teams-setup/00-platform/01.operativos/OPERATIVO_PJM_MEMORY-SERVICE.md` | Tu OPERATIVO específico del proyecto |
...
Los comandos exactos están en tu `OPERATIVO_PJM_MEMORY-SERVICE.md` (PASO 1, archivo 3). Ejecutá:
...
**Fuente de verdad operativa:** `OPERATIVO_PJM_MEMORY-SERVICE.md`
