# SETUP — Product Manager (PM) | Memory Service

**Propósito:** Esto es lo que debes leer al iniciar sesión como Product Manager de Memory Service. No leas toda la carpeta `00-platform/`. Solo lo que dice acá.
...
```bash
cd c:/Users/Martin/Documents/virtual-teams/memory-service/.vtt/worktrees/project-pm
git status   # debe mostrar branch wt-project-pm (idle) o branch de tarea activa
```

### Validación de entorno
```bash
test -d c:/Users/Martin/Documents/virtual-teams/memory-service/.vtt/worktrees/project-pm/ \
  && echo "Worktree OK" \
  || echo "ERROR: worktree project-pm no existe. Escalar a TL."
```
...
> git worktree add ../.vtt/worktrees/project-pm -b wt-project-pm origin/main
> ```
...
|---------|----------------------|
| `memory-service/.vtt/worktrees/project-pm/` | ✅ **PRIMARIO** — tu worktree |
...
| 3 | `c:/Users/Martin/Documents/virtual-teams/virtual-teams-setup/00-platform/01.operativos/OPERATIVO_PM_MEMORY-SERVICE.md` | Tu OPERATIVO específico del proyecto |
...
| 5 | `c:/Users/Martin/Documents/virtual-teams/virtual-teams-setup/00-platform/06.Documentos_soporte/PROCESO_ASIGNACION_TAREAS_v3.md` | Proceso de asignación |
...
Los comandos exactos están en tu `OPERATIVO_PM_MEMORY-SERVICE.md` (PASO 1, archivo 3). Ejecutá:
...
1. **PASO 0** — `cd` a tu worktree (`.vtt/worktrees/project-pm/`) + validar que existe
...
**Fuente de verdad operativa:** `OPERATIVO_PM_MEMORY-SERVICE.md`
