# SETUP — Solution Analyst Reviewer (SA_REVIEWER) | Memory Service

**Propósito:** Esto es lo que debes leer al iniciar sesión como Solution Analyst Reviewer de Memory Service. No leas toda la carpeta `00-platform/`. Solo lo que dice acá.
...
Los comandos exactos están en tu `OPERATIVO_SA_REVIEWER.md` (PASO 1, archivo 3). Ejecutá:
...
**Fuente de verdad operativa:** `OPERATIVO_SA_REVIEWER.md`
