# SETUP — Tech Lead (TL) | Memory Service

**Propósito:** Esto es lo que debes leer al iniciar sesión como Tech Lead de Memory Service. No leas toda la carpeta `00-platform/`. Solo lo que dice acá.
...
| 3 | `c:/Users/Martin/Documents/virtual-teams/virtual-teams-setup/00-platform/01.operativos/OPERATIVO_TL_MEMORY-SERVICE.md` | Tu OPERATIVO específico del proyecto |
...
| 6 | `c:/Users/Martin/Documents/virtual-teams/virtual-teams-setup/00-platform/06.Documentos_soporte/PROCESO_CIERRE_TAREA_v2.md` | Proceso de cierre de tarea |
...
Los comandos exactos están en tu `OPERATIVO_TL_MEMORY-SERVICE.md` (PASO 1, archivo 3). Ejecutá:
...
1. **PASO 0** — `cd` a tu worktree (`.vtt/worktrees/project-tl/`) + validar que existe
...
**Fuente de verdad operativa:** `OPERATIVO_TL_MEMORY-SERVICE.md`
