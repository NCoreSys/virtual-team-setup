...
5.1.5 El TL crea el archivo `LIVING_DOCUMENTS_[PROYECTO].md` en `00-platform/06.Documentos_soporte/` con la tabla de LDs. Ver formato en Anexo 1.
...
Archivo: `LIVING_DOCUMENTS_[PROYECTO].md` en `00-platform/06.Documentos_soporte/`
