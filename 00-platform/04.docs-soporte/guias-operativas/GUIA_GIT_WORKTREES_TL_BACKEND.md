# Guía Git Worktrees — Single Manual Control Surface

**Versión:** 2.0
**Fecha:** 2026-05-14
**Aplicable a:** TL Memory Service (y cualquier agente que necesite trabajar en código)
**Reemplaza:** v1.0 (que usaba worktree por tarea — enfoque incorrecto)
