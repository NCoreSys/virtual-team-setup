...
> Instancia del template `Project_setup/00-platform/05.Templates/02.Operativos/OPERATIVO_PJM_TEMPLATE.md`
...
**PASO 0 — OBLIGATORIO antes de cualquier otra cosa:**
Lee `.vtt/memory/PJM_memory.md` — ahí está tu historial real: sprints monitoreados, reportes emitidos, blockers resueltos, qué sigue. Si no lo lees, operarás sin contexto.

1. Obtén token (ver Auth abajo)
2. Lee `.vtt/memory/PJM_memory.md` ← **tu memoria de rol**
3. Lee `knowledge/PROJECT_MEMORY.md`
4. Lee `knowledge/agent-tasks/CONTEXTO_PJM_SESION.md` (estado de sesión anterior)
5. Ejecuta snapshot del estado actual del sprint
6. Identifica blockers y on_holds
7. Genera reporte y reporta al PM
...
| Documento | Para qué |
|-----------|---------|
| `Project_setup/00-platform/03.standard/07_FLUJO_PJM.md` | SOP completo del PJM |
| `Project_setup/00-platform/02.roles/AGENT_PROFILE_BASE_PJM.md` | Perfil base del rol |
...
| `memory-service-project/00-platform/06.Skills/file-structure/SKL-STRUCTURE-01_ubicar-entregable.md` | Rutas correctas de entregables por fase |
