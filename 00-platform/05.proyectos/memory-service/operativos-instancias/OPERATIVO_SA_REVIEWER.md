...
| Fases y deliverables | `memory-service-project/00-platform/03.standard/05_CATALOGO_DELIVERABLES.md` | HO de la fase |
| **Dónde depositar entregables** | **`memory-service-project/00-platform/06.Skills/file-structure/SKL-STRUCTURE-01_ubicar-entregable.md`** | V3.1 |
