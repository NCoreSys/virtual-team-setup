...
| 3 | `00-agent-setup/05.Templates/05.Proyecto/02.Genericos/TEMPLATE_ASIGNACION_TAREARev.md` | Template assignments (v3) |
| 4 | `00-agent-setup/06.Documentos_soporte/PROCESO_CIERRE_TAREA_v2.md` | Workflow cierre con modelo dinámico |
| 5 | `00-agent-setup/06.Skills/CATALOGO_SKILLS_MEMORY_SERVICE.md` v1.3 | Catálogo de skills (34 skills) |
...
**Generar mensaje (SKL-MESSAGE-01):**
```bash
python scripts/gen_mensaje.py MS-XXX --post
```

El script publica el mensaje como comment en VTT con comandos de arranque, datos del sistema, paths del ASSIGNMENT/BRIEF y referencias a SKL-MANIFEST-01.

También guarda en `knowledge/agent-tasks/messages/[fase]/[sprint]/MENSAJE_MS-XXX.md`.
...
> **Skill operativa:** `00-agent-setup/06.Skills/dynamic-model/SKL-DYNAMIC-MODEL-01_cierre-modelo-dinamico.md`
...
> **Skill operativa:** `00-agent-setup/06.Skills/manifest/SKL-MANIFEST-01_generar-manifest.md`
>
