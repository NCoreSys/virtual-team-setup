...
1. [Criterios de Aceptación](#1-criterios-de-aceptación)
...
### ¿Qué es?
Una lista de condiciones que una tarea debe cumplir para considerarse completada.

### ¿Para qué sirve?
- Define claramente qué significa "terminado"
- Evita ambigüedad entre quien asigna y quien ejecuta
- Facilita la verificación en QA

### ¿Cómo se usa?

**Paso 1:** PM o TL crea los criterios al asignar la tarea.

**Paso 2:** Agente ve los criterios antes de empezar a trabajar.

**Paso 3:** Agente marca cada criterio como cumplido o no cumplido al terminar.

**Paso 4:** TL verifica los criterios marcados.

### Ejemplo

Tarea: "Implementar endpoint POST /users"

| Criterio | Tipo |
|----------|------|
| El endpoint acepta email y password | Funcional |
| Retorna 400 si email inválido | Funcional |
| Password se hashea con bcrypt | Seguridad |
...
| Tipo | Cuándo usarlo |
|------|---------------|
| `functional` | Comportamiento esperado del sistema |
...
### ¿Qué es?
El registro de si un criterio se cumplió o no.

### ¿Para qué sirve?
- Documenta quién verificó qué
- Permite rastrear por qué algo no se cumplió
- Crea historial de verificación
...
3. Por cada criterio, click en [Met] o [Not Met]
4. Agregas notas si es necesario (ej: "Verificado en PR #123")

**Como TL/QA:**

1. Revisas los criterios marcados por el agente
2. Verificas que realmente se cumplieron
3. Tu firma queda como "Verified by"

### Estados

| Estado | Significado |
|--------|-------------|
| `pending` | No evaluado todavía |
| `met` | Cumplido |
| `not_met` | No cumplido |
