...
**Orden de consulta:**
1. `memory-service-project/knowledge/kickoff/KICKOFF_MEMORY_SERVICE.md` — Alcance IN/OUT aprobado
...
**Orden de consulta:**
1. `memory-service-project/knowledge/kickoff/KICKOFF_MEMORY_SERVICE.md` — Alcance original aprobado
...
| Situación | Fuente |
|-----------|--------|
| ¿Está dentro del alcance R1? | `KICKOFF_MEMORY_SERVICE.md` — sección IN/OUT SCOPE |
...
**Fuente de verdad de este documento:** `00-agent-setup/03.standard/10_FLUJO_SA_REVIEWER.md`
